...
class CashCardApplicationTests {
    ...
    @Test
    public void shouldNotUpdateCashCardThatDoesNotExist() {

        CashCard unknownCard = new CashCard(null, 456.78, "sarah1");
    ...
    @Test
    public void shouldNotAllowDeletingCashCardNotOwned() {
